...
```
cd existing_repo
git remote add origin https://gitlab.mi.hdm-stuttgart.de/ls228/projekt_lisa_lisa.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.mi.hdm-stuttgart.de/ls228/projekt_lisa_lisa/-/settings/integrations)

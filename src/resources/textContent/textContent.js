...
export const ueberNatanSecondPart = (
    ...
    der Stuttgarter Hilfsorganisation <a href="src/resources/textContent/textContent" target="_blank">STELP</a>, die hinter der Idee steckt und für
    ...
    ebenfalls alles andere als gewöhnlich: Ganz nach dem <a href="src/resources/textContent/textContent" target="_blank">STELP</a> Prinzip, dass jeder
    einbringt, was er kann, arbeiten im NATAN hinter der Theke, im Service und in der Küche Menschen, die sich für die
    gute Sache einsetzen — ehrenamtlich! Sei auch du dabei und <a href="src/resources/textContent/textContent#volunteers">werde Volunteer</a>!
        </p>
    </div> );

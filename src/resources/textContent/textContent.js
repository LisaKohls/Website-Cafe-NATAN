...
export const ueberNatanSecondPart = (
    <div>
        <p>
            Geht nicht? Geht doch — und zwar bei uns! Denn der gesamte Gewinn des NATAN fließt in die internationalen
            Projekte
            der Stuttgarter Hilfsorganisation <a href="src/resources/textContent/textContent" target="_blank">STELP</a>,
            die hinter der Idee steckt und für
            die Umsetzung gesorgt hat. Starke Partner und Sponsoren unterstützen uns durch günstige Konditionen; ein
            weiteres
            Plus, damit jeder zusätzliche Euro dort ankommt, wo er am dringendsten benötigt wird.
            <br/>
            <br/>
            Dass das Trinkgeld davon ausgenommen ist, versteht sich von selbst: Es geht ohne Abzüge an unsere Crew. Und
            die ist
            ebenfalls alles andere als gewöhnlich: Ganz nach dem <a href="src/resources/textContent/textContent"
                                                                    target="_blank">STELP</a> Prinzip, dass jeder
            einbringt, was er kann, arbeiten im NATAN hinter der Theke, im Service und in der Küche Menschen, die sich
            für die
            gute Sache einsetzen — ehrenamtlich! Sei auch du dabei und <a
            href="src/resources/textContent/textContent#volunteers">werde Volunteer</a>!
        </p>
    </div>);
